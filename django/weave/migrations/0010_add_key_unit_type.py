...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tool.height'
        db.alter_column('weave_tool', 'height', self.gf('weave.fields.PercentField')())

        # Changing field 'Tool.width'
        db.alter_column('weave_tool', 'width', self.gf('weave.fields.PercentField')())

        # Changing field 'Row.width'
        db.alter_column('weave_row', 'width', self.gf('weave.fields.PercentField')())

        # Changing field 'Row.height'
        db.alter_column('weave_row', 'height', self.gf('weave.fields.PercentField')())

        # Adding field 'Indicator.key_unit_type'
        db.add_column('weave_indicator', 'key_unit_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['weave.KeyUnitType'], null=True), keep_default=False)

        # Adding field 'DataFilter.key_unit_type'
        db.add_column('weave_datafilter', 'key_unit_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['weave.KeyUnitType'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Tool.height'
        db.alter_column('weave_tool', 'height', self.gf('PercentField')())

        # Changing field 'Tool.width'
        db.alter_column('weave_tool', 'width', self.gf('PercentField')())

        # Changing field 'Row.width'
        db.alter_column('weave_row', 'width', self.gf('PercentField')())

        # Changing field 'Row.height'
        db.alter_column('weave_row', 'height', self.gf('PercentField')())

        # Deleting field 'Indicator.key_unit_type'
        db.delete_column('weave_indicator', 'key_unit_type_id')

        # Deleting field 'DataFilter.key_unit_type'
        db.delete_column('weave_datafilter', 'key_unit_type_id')
    ...
    models = {
        ...
        'weave.row': {
            ...
            'height': ('weave.fields.PercentField', [], {'default': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'width': ('weave.fields.PercentField', [], {'default': '100'})
        },
        'weave.tool': {
