...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('weave_tool_table_columns', (
            ...
            ('tool', models.ForeignKey(orm.Tool, null=False)),
            ('indicator', models.ForeignKey(orm.Indicator, null=False))
        )) 
    ...
    models = {
        ...
        'weave.tool': {
            ...
            'table_columns': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['weave.Indicator']"}),
