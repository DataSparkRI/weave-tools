...
class Migration:
    ...
    def forwards(self, orm):
        db.rename_table('weave_datatable', 'weave_datafilter')
        db.rename_column('weave_clientconfiguration', 'dataTable_id', 'data_filter_id')
        db.rename_column('weave_tool', 'dataTable_id', 'data_filter_id')
    
    def backwards(self, orm):
        db.rename_table('weave_datafilter', 'weave_datatable')
        db.rename_column('weave_clientconfiguration', 'data_filter_id', 'dataTable_id')
        db.rename_column('weave_tool', 'data_filter_id', 'dataTable_id')
