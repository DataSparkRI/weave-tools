...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Indicator.min'
        db.add_column('weave_indicator', 'min', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Indicator.max'
        db.add_column('weave_indicator', 'max', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Indicator.min'
        db.delete_column('weave_indicator', 'min')

        # Deleting field 'Indicator.max'
        db.delete_column('weave_indicator', 'max')
