...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tool.primary_geometry_collection'
        db.add_column('weave_tool', 'primary_geometry_collection', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tools_as_primary', null=True, to=orm['weave.GeometryCollection']), keep_default=False)

        # Adding field 'Tool.secondary_geometry_collection'
        db.add_column('weave_tool', 'secondary_geometry_collection', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tools_as_secondary', null=True, to=orm['weave.GeometryCollection']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Tool.primary_geometry_collection'
        db.delete_column('weave_tool', 'primary_geometry_collection_id')

        # Deleting field 'Tool.secondary_geometry_collection'
        db.delete_column('weave_tool', 'secondary_geometry_collection_id')
