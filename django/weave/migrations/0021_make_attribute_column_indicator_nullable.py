...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClientConfiguration.file'
        db.alter_column('weave_clientconfiguration', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True))

        # Changing field 'AttributeColumn.indicator'
        db.alter_column('weave_attributecolumn', 'indicator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['indicators.Indicator'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'ClientConfiguration.file'
        db.alter_column('weave_clientconfiguration', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True))

        # Changing field 'AttributeColumn.indicator'
        db.alter_column('weave_attributecolumn', 'indicator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['indicators.Indicator']))
