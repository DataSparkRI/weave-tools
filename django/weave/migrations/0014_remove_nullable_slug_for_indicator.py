...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('weave_indicator', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50))
    
    
    def backwards(self, orm):
        
        # Changing field 'Indicator.slug'
        db.alter_column('weave_indicator', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, null=True))
