...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('weave_category', (
            ('id', orm['weave.category:id']),
            ('parent', orm['weave.category:parent']),
            ('name', orm['weave.category:name']),
        ))
        db.send_create_signal('weave', ['Category'])
        
        # Adding field 'Indicator.category'
        db.add_column('weave_indicator', 'category', orm['weave.indicator:category'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Indicator.category'
        db.delete_column('weave_indicator', 'category_id')
    ...
    models = {
        ...
        'weave.indicator': {
            'category': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'variables'", 'null': 'True', 'to': "orm['weave.Category']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
