...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Indicator.short_label'
        db.alter_column('weave_indicator', 'short_label', self.gf('django.db.models.fields.CharField')(max_length=300))
    
    
    def backwards(self, orm):
        
        # Changing field 'Indicator.short_label'
        db.alter_column('weave_indicator', 'short_label', self.gf('django.db.models.fields.CharField')(max_length=100))
