...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'weave.indicatordata': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indicator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['weave.Indicator']"}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'key_unit_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['weave.KeyUnitType']"}),
